...
- **[omec-project/.github](https://github.com/omec-project/.github)** ([v0.0.7](https://github.com/omec-project/.github/releases/tag/v0.0.7)) -  *(3 days ago)*
...
- [Address issue with outdated configuration file](https://github.com/omec-project/simapp/pull/196) on **[omec-project/simapp](https://github.com/omec-project/simapp)** *(2 days ago)*
- [Correct HTML closing tag](https://github.com/omec-project/sdcore-docs/pull/88) on **[omec-project/sdcore-docs](https://github.com/omec-project/sdcore-docs)** *(2 days ago)*
- [Revert PRs #85 and #86](https://github.com/omec-project/sdcore-docs/pull/87) on **[omec-project/sdcore-docs](https://github.com/omec-project/sdcore-docs)** *(2 days ago)*
- [Address issue with file name by changing hyphen to underscore](https://github.com/omec-project/sdcore-docs/pull/86) on **[omec-project/sdcore-docs](https://github.com/omec-project/sdcore-docs)** *(2 days ago)*
- [Remove outdated components from Helm Charts](https://github.com/omec-project/sdcore-helm-charts/pull/104) on **[omec-project/sdcore-helm-charts](https://github.com/omec-project/sdcore-helm-charts)** *(2 days ago)*
- [make several changes to docs, including its theme and update dependencies](https://github.com/omec-project/sdcore-docs/pull/85) on **[omec-project/sdcore-docs](https://github.com/omec-project/sdcore-docs)** *(3 days ago)*
- [Fix issue with reusable workflow such that it skips umbrella chart if it already exists](https://github.com/omec-project/.github/pull/94) on **[omec-project/.github](https://github.com/omec-project/.github)** *(3 days ago)*
- [Improve reusable workflows, especially when publishing Helm Charts](https://github.com/omec-project/.github/pull/92) on **[omec-project/.github](https://github.com/omec-project/.github)** *(3 days ago)*
